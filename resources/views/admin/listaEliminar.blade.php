...
<head>
    ...
    <title>Lista usuario eliminar</title>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a title="Dar de baja" class="btn btn-primary active" aria-current="page" href="darDeBaja/{{$usuario->id_usuario}}" type="submit"><i class="fa-solid fa-xmark"></i></a>
                                @else
                                <a title="Dar de alta" class="btn btn-success active" aria-current="page" href="darDeAlta/{{$usuario->id_usuario}}" type="submit"><i class="fa-solid fa-check"></i></a>
                                @endif
                                <a title="Eliminar" class="btn btn-danger" aria-current="page" href="EliminarUsuario/{{$usuario->id_usuario}}" type="submit"><i class="fas fa-trash-alt"></i></a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
