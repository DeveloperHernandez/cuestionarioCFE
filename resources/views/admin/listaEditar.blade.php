                ...
                <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a title="Detalles" class="btn btn-warning" aria-current="page" href="editarUsuario/{{$usuario->id_usuario}}" type="submit"><i class="fa-sharp fa-solid fa-rectangle-list"></i></a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
