            ...
            <div class="col-md-9 contenido-principal">
                ...
                <div class="card card-usuario">
                    <div class="card-body">
                        ...
                        <p class="card-text"><strong>APELLIDO PATERNO:</strong>
                            {{ $usuario->apellido_paterno ? $usuario->apellido_paterno : 'Sin apellido paterno' }}</p>
                        <p class="card-text"><strong>APELLIDO MATERNO:</strong>
                            {{ $usuario->apellido_materno ? $usuario->apellido_materno : 'Sin apellido materno' }}</p>
                        <p class="card-text"><strong>TELÉFONO:</strong> 
                            {{ $usuario->telefono ? $usuario->telefono : 'Sin telefono' }}</p>
                        <p class="card-text"><strong>CORREO ELECTRÓNICO:</strong> 
                            {{ $usuario->correo_electronico ? $usuario->correo_electronico : 'Sin correo_electronico' }}</p>
                        <p class="card-text"><strong>ROL:</strong> 
                            {{ $usuario->rol ? $usuario->rol : 'Sin rol' }}</p>
