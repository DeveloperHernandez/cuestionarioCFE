        ...
        <div class="row">
            ...
            <div class="col-md-9 contenido-principal">
                ...
                <form method="post" action="{{ route('guardar_geoestadisticas') }}">
                    ...
                    <p class="text-justify">Rellenar de cada una de las columnas de acuerdo con la localidad, municipio y estado donde esté interesado en tender su infraestructura. <strong>Importante:</strong> Las áreas señaladas deben de estar acreditadas dentro del Registro público de concesiones de IFT a nombre del solicitante.<br> <br>Indicar las localidades, municipios o Estados en los que iniciará a prestar servicios. El área geoestadística a registrar puede ser desde la totalidad del Estado, hasta las localidades específicas de un Estado en las que se ofrecerá el(los) servicio(s) de telecomunicaciones.</p>
                    ...
                    <div class="form-group">
                        <label for="uso_posteria">3. Indicar si ya se encuentra haciendo uso de la postería solicitada</label>
